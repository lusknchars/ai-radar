...
.beam-input input:focus-visible{outline-offset:0;border-radius:4px}
...
.paper-lead-image a{display:block;background:#fff;box-shadow:0 8px 28px #20202415;border:1px solid #d3c9cc}
.paper-lead-image img{display:block;width:100%;height:auto}
...
@media(max-width:760px){.article-opening.has-paper-image{grid-template-columns:1fr;gap:26px}.paper-lead-image{max-width:440px;margin:0 auto;width:100%}}
