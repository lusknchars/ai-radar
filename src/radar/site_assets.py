...
.skill-download,.research-actions a.skill-download{display:inline-flex;align-items:center;justify-content:center;min-height:44px;padding:10px 16px;border:1px solid #cb2957;border-radius:7px;background:#cb2957;color:white;text-decoration:none;font-size:12px;line-height:1.4}
.skill-download:hover{background:#a82049;color:white}
