...
def _pagina_estatica(titulo: str, atual: str, dia: str, corpo: str,
    ...
    return (
        ...
        f'<h1>{escape(heading or titulo)}</h1>{lead_figure}{header_deck}'
        '</div></header>'
...
def render_community(data: SiteData, public_config: PublicConfig) -> str:
    ...
    content = (
        ...
        '<li><span>01</span><strong>Open GitHub</strong><small>Use an existing account or create one free.</small></li>'
        '<li><span>02</span><strong>Choose a paper</strong><small>Start with one claim, equation, or result.</small></li>'
        '<li><span>03</span><strong>Share what you learn</strong><small>Include your model, baseline, and test conditions.</small></li>'
        '</ol>'
        ...
        '<p>Link to the page, equation or code you are discussing. A good first post '
        'can be as small as: <q>What would this change in my product?</q> or '
        '<q>I tried this on [model] with [baseline] and measured [result].</q></p>'
        '<p>When sharing a test, include the model, hardware, baseline and results. '
        'Say what you measured and what remains uncertain. Keep criticism focused on the work.</p>'
